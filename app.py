...
def paytraq_full_report():
    ...
    # Atgriežam klienta papildu info
...
def get_orders_last_12_months_internal(client_id):
    # Paliek kā tev jau bija
    return Response("✅ Funkcija get_orders_last_12_months_internal darbojas (saīsināta testa versija)", mimetype="text/plain")
