...
def paytraq_full_report():
    ...
    output.append(f"\n🔎 ClientID: {client_id}")
    output.append(f"➡️ Skatīt 12 mēnešu pasūtījumus: /get-orders-last-12-months-auto?client_id={client_id}")
...
def redirect_to_manual():
    ...
    if not client_id:
        return Response("❌ Nav norādīts klienta ID", mimetype="text/plain")
